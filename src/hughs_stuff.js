$(document).ready(function(){
  ...
  $('#features').parent().parent().append('<div style="position: absolute;height:306px;width:645px;top:75px;left:500px;z-index:2;background: -moz-linear-gradient(left,  rgba(51,51,51,0) 0%, rgba(51,51,51,0.8) 100%); /* FF3.6+ */background: -webkit-gradient(linear, left top, right top, color-stop(0%,rgba(51,51,51,0)), color-stop(100%,rgba(51,51,51,0.8))); /* Chrome,Safari4+ */background: -webkit-linear-gradient(left,  rgba(51,51,51,0) 0%,rgba(51,51,51,0.8) 100%); /* Chrome10+,Safari5.1+ */background: -o-linear-gradient(left,  rgba(51,51,51,0) 0%,rgba(51,51,51,0.8) 100%); /* Opera 11.10+ */background: -ms-linear-gradient(left,  rgba(51,51,51,0) 0%,rgba(51,51,51,0.8) 100%); /* IE10+ */background: linear-gradient(to right,  rgba(51,51,51,0) 0%,rgba(51,51,51,0.8) 100%); /* W3C */filter: progid:DXImageTransform.Microsoft.gradient( startColorstr="#00000000", endColorstr="#a6000000",GradientType=1 ); /* IE6-9 */"></div>');
